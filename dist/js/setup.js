...
/* @source ../bower_components/ozjs/oz.js */;
...
/* @source underscore/underscore.js */;
...
/* @source ../js/threes/modules/keyboard_listener.js */;

define("../js/threes/modules/keyboard_listener", [
  "jquery",
  "underscore",
  "backbone"
], function ($, _, Backbone) {
...
/* @source ../js/threes/modules/env.js */;

define("../js/threes/modules/env", [], function () {
...
/* @source ../js/threes/modules/swiper.js */;

define("../js/threes/modules/swiper", [
  "jquery",
  "underscore",
  "backbone",
  "threes/modules/env"
...
/* @source ../js/threes/app.js */;

define("../js/threes/app", [
  "jquery",
  "underscore",
  "backbone"
], function($, _, Backbone) {
...
/* autogeneration */
define("magnific-popup-src", [
  "jquery"
], function(){});

/* @source ../js/threes/views/utils/popup.js */;

define("../js/threes/views/utils/popup", [
  "jquery",
  "underscore",
  "backbone",
  "magnific-popup",
...
/* @source ../js/threes/modules/random_pool.js */;

define("../js/threes/modules/random_pool", [
  "underscore"
], function (_) {
...
/* @source ../js/threes/views/utils/menu.js */;

define("../js/threes/views/utils/menu", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app"
...
/* @source ../js/threes/views/utils/help.js */;

define("../js/threes/views/utils/help", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app"
...
/* @source ../js/threes/views/playing.footer.js */;

define("../js/threes/views/playing.footer", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app"
...
/* @source ../js/threes/views/playing.header.js */;

define("../js/threes/views/playing.header", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app"
...
/* @source ../js/mod/jquery.transition.js */;

;(function (factory) {
  if (typeof define === 'function' && define.amd) {
    define("../js/mod/jquery.transition", [
      "jquery"
    ], factory);
  } else {
    factory(jQuery);
...
/* @source ../js/threes/views/tile.js */;

define("../js/threes/views/tile", [
  "jquery",
  "underscore",
  "backbone",
...
/* @source ../js/threes/models/tile.js */;

define("../js/threes/models/tile", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app",
...
/* @source ../js/threes/modules/matrix_manager.js */;

define("../js/threes/modules/matrix_manager", [
  "jquery",
  "underscore",
  "backbone",
  "threes/models/tile"
...
/* @source ../js/threes/collections/tiles.js */;

define("../js/threes/collections/tiles", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app",
...
/* @source ../js/threes/views/playing.js */;

define("../js/threes/views/playing", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app",
...
/* @source ../js/threes/views/home.js */;

define("../js/threes/views/home", [
  "jquery",
  "underscore",
  "backbone",
  "threes/app"
...
/* @source ../js/threes/main.js */;

define("../js/threes/main", [
  "jquery",
  "underscore",
  "backbone",
  "bowser",
